...
END
						...
						citoyen=res[0]
						info="Lien de vote 2nd tour envoyé à %s %s" % [citoyen['firstname'],citoyen['lastname']]
						API.log.info(info)
						notifs.push([
							info,
							"supporteurs",
				...
				begin
					...
					result=API.mandrill.messages.send_template("laprimaire-org-pre-2nd-tour-de-vote",[],message)
