...
insert into users (email,firstname,lastname,registered,tags) select a.email,a.firstname,a.lastname,a.signed as registered,ARRAY['toutes_candidates']::text[] as tags from toutes_candidates as a where a.email=$1 returning *;
END
